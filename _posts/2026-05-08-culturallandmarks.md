...
```bash
git clone https://github.com/nuno-joao-andrade-dev/cultural-landmarks-assistant.gemini.series.git
cd cultural-landmarks-assistant.gemini.series
npm install
```
...
To run this project, you need to authenticate your environment to access Google Cloud services. The Gemini AI model will use your Application Default Credentials (ADC).
 ...
 */
 ...
 appName: 'Cultural LandmarksWorkshop',
 agent,
...
## Step 2: Integrating the Local Knowledge Base
 ...
 */
 ...
 placeholder="Ask about Cultural Landmarks..."
 />
